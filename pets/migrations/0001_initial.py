    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name_en_GB', models.CharField(db_index=True, help_text='The species name of the pet', max_length=100, null=True, unique=True, verbose_name='name')),
                ('name_pt_PT', models.CharField(db_index=True, help_text='The species name of the pet', max_length=100, null=True, unique=True, verbose_name='name')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('weight_kg', models.DecimalField(decimal_places=2, help_text='The weight of the pet in kilograms', max_digits=5, verbose_name='weight (kg)')),
                ('height_cm', models.DecimalField(decimal_places=2, help_text='The weight of the pet in centimeters', max_digits=5, verbose_name='weight (cm)')),
