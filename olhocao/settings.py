...
env = environ.Env(
    ...
    HOTEL_REFUND_PERCENTAGE=(float, 0.85),

    RECAPTCHA_SITE_KEY=(str, ''),
    RECAPTCHA_SECRET_KEY=(str, ''),

    TOCONLINE_BASE_URL=(str, 'https://api17.toconline.pt'),
    TOCONLINE_OAUTH_CLIENT_ID=(str, 'fake-client-id'),
    TOCONLINE_OAUTH_CLIENT_SECRET=(str, 'fake-client-secret'),
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'backoffice.context_processors.unread_contact_requests_count',
            ],
        },
    },
]
